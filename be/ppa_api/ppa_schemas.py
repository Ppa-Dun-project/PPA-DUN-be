# Pydantic schemas for external PPA API request/response data.
# Defines batter/pitcher stats, league context, draft context models with validation,
# and converter functions that map between the external API's snake_case JSON
# and the internal camelCase models.
